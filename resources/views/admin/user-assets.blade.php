...
<div class="flex flex-col md:flex-row justify-between items-center mb-6">
    ...
    {{-- <a href="{{ route('admin.users.assets.create', $user) }}"
       class="bg-green-500 hover:bg-green-600 text-white px-5 py-2 rounded shadow transition duration-200">
        ثبت مال جدید
    </a> --}}
</div>
...
<div class="overflow-x-auto shadow rounded-lg">
    <table class="min-w-full bg-white table-fixed">
        <thead class="bg-gray-100 border-b">
            <tr>
                <th class="text-center p-3 font-medium text-gray-700">عنوان</th>
                <th class="text-center p-3 font-medium text-gray-700">شماره</th>
                <th class="text-center p-3 font-medium text-gray-700">ستاد</th>
                <th class="text-center p-3 font-medium text-gray-700">تاریخ</th>
            ...
            @forelse($assets as $asset)
                <tr class="border-b hover:bg-gray-50 transition duration-150">
                    ...
                    <td class="p-3 text-center">
                        <a href="{{ route('admin.users.assets.edit', [$user, $asset]) }}"
                           class="text-blue-600 hover:text-blue-800 font-medium mr-2">ویرایش</a>
                        <form action="{{ route('admin.users.assets.destroy', [$user, $asset]) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
